            ...
            <main className="w-full flex">
                <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                    <div className="relative z-10 w-full max-w-md">
                        ...
                        <img src="./reshot-icon-interview-DNGJF9VUEX.svg" width={100} />
                        <div className=" mt-16 space-y-3">
                            <h3 className="text-white text-3xl font-bold">Prepare and strengthen your skills for interviews</h3>
                            <p className="text-gray-300">
                                Create an account and start your preparation with help of AI
                            </p>
                            <div className="flex items-center -space-x-2 overflow-hidden">
                                <img src="https://randomuser.me/api/portraits/women/79.jpg" className="w-10 h-10 rounded-full border-2 border-white" />
                                <img src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg" className="w-10 h-10 rounded-full border-2 ssborder-white" />
                                ...
                                <p className="text-sm text-gray-400 font-medium translate-x-5">
                                    Join and learn with InterviewAce community
                                </p>
                            </div>
                        </div>
                    </div>
